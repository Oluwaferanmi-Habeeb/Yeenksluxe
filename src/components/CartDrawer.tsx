    ...
    <div className="drawer-layer" role="presentation">
      ...
      <aside className="cart-drawer" role="dialog" aria-modal="true" aria-labelledby="bag-title">
        ...
        <div className="cart-items">
          {cart.length === 0 ? <div className="empty-bag"><span>01</span><h3>Your bag is empty.</h3><p>Pick a piece to get started.</p><button className="button button-dark" onClick={continueShopping}>Shop all pieces</button></div> : cart.map((item, index) => (
