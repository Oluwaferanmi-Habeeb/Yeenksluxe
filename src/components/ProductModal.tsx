...
export default function ProductModal() {
  const {
    ...
    fitHeight, setFitHeight, fitWeight, setFitWeight, addToCart
  } = useStore();
          ...
          <div className="dossier-tabs">
            {(['info', 'fit', 'specs'] as const).map((tab) => (
              <button key={tab}
                ...
                {tab === 'info' ? 'INFO' : tab === 'fit' ? 'FIT FINDER' : 'FABRIC & SIZE'}
              </button>
            ))}
          </div>
                  ...
                  <div style={{ marginTop: '1.25rem' }}>
                    ...
                    <div className="color-options">
                      {selectedProduct.colors.map((clr) => (
                        <div key={clr}
                          className={`color-dot ${chosenColor === clr ? 'active' : ''}`}
                ...
                <div className="specs-container">
                  <div>
                    ...
                    <ul className="specs-list">
                      ...
                      <li><strong>Fit:</strong> Relaxed / Drop-shoulder silhouette</li>
                      <li><strong>Hardware:</strong> Gold-toned custom YKK zippers</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="specs-title-sub">CARE RATING</h4>
