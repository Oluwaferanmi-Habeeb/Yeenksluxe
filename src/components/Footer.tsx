  ...
  return (
    <footer className="footer">
      <div className="container footer-top">
        <div className="footer-brand"><strong>YEENKSLUXE<span>®</span></strong><p>YEENKSLUXE, also known as Yeenks Wears. Graphic tees, hoodies and caps from Lagos.</p></div>
        ...
        <div><h2>Help</h2><Link href="/yeenks-wears">Yeenks Wears</Link><Link href="/shipping">Delivery</Link><Link href="/returns">Returns & exchanges</Link><Link href="/size-guide">Size guide</Link><a href="#faq">FAQ</a></div>
